...
ENGINE_API extern void *AllocMemory( size_t memsize );
ENGINE_API extern void *_debug_AllocMemory( SLONG memsize, int iType, const char *strFile, int iLine);
ENGINE_API extern void *AllocMemoryAligned( size_t memsize, size_t slAlignPow2);
/* Free a block of memory. */
ENGINE_API extern void FreeMemory( void *memory);
ENGINE_API extern void FreeMemoryAligned( void *memory);

ENGINE_API extern void ResizeMemory( void **memory, size_t memsize );
ENGINE_API extern void GrowMemory( void **memory, size_t memsize );
ENGINE_API extern void ShrinkMemory( void **memory, size_t memsize );
